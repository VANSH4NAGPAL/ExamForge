    ...
    <div className="min-h-screen bg-bg p-4 md:p-10">
      <div className="max-w-5xl mx-auto">
        <div className="flex items-center gap-2 text-sm text-muted-fg mb-8">
          ...
          <span>/</span>
          <span className="text-muted-fg">CSA ServiceNow Notes</span>
        </div>

        <div className="mb-10">
          <h1 className="text-4xl font-extrabold text-fg tracking-tight mb-3">ServiceNow CSA Study Notes</h1>
          <p className="text-muted-fg text-base">Comprehensive study material covering all major topics for the Certified System Administrator exam.</p>
        </div>

        {notes.length === 0 ? (
          <div className="card text-center py-20 border-dashed opacity-50">
            <p className="text-muted-fg">No notes found. Please make sure the markdown files are in the content/notes/csa directory.</p>
          </div>
        ) : (
